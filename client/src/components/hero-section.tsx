      ...
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-gray-600 mb-12 max-w-4xl mx-auto leading-relaxed px-4 sm:px-0">
            Watch how I help SaaS founders drive traction, built a user base, and attract investors all within 4 weeks of implementing a marketing engine built for early stage startups.
          </p>
