    ...
    <section className="px-3 sm:px-6 lg:px-8 pt-[100px] sm:pt-[120px] pb-[80px] sm:pb-[120px]">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h1 
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-gray-900 mb-6 sm:mb-8 tracking-tight leading-tight px-2 sm:px-0 focus:outline-none focus:ring-2 focus:ring-gray-300 focus:bg-gray-50 rounded-lg transition-colors"
