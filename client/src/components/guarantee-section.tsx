    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto text-center">
        <div className="glass-card p-12 rounded-3xl">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">We're so confident in our validation process that we guarantee results. All creatives are free until we reach you lead goals.</p>
